  ...
  return class P2PLoader extends XhrLoader {
    ...
    loadInternal() {
      if (this.frag) {
        ...
        this.abortCallback = streamrootWrapper.srModule.getSegment({url: this.url, headers: headers, withCredentials: this.withCredentials} , {onSuccess: this.loadSuccess.bind(this), onError: this.loadError.bind(this), onProgress: this.loadprogress.bind(this)}, segmentView);
      } else {
        super.loadInternal();
      }
    }
