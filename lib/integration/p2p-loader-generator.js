...
import { createXhrSetupShim } from './xhr-setup-shim-factory';
    ...
    return class P2PLoader extends XhrLoader {
        ...
        loadInternal() {
            if (this.frag) {
                ...
                if (this.xhrSetup) {
                    let { placeholder, xhrSetupShim } = createXhrSetupShim();
                    this.xhrSetup(xhrSetupShim);
                    Object.assign(headers, placeholder.headers);
                    withCredentials = placeholder.withCredentials;
                }
