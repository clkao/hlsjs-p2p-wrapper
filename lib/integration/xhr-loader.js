...
class XhrLoader {
    ...
    abort() {
        ...
        // just to make explicit that the ´readyState` property is something
        // optional on the interface we expect from the loader. when it doesn't
        // have it we abort anyway.
        if (loader && (loader.readyState === undefined || loader.readyState !== 4)) {
