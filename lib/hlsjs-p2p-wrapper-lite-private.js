 ...
 * @class
 */
class HlsjsP2PWrapperLitePrivate {
    ...
    createPeerAgent(p2pConfig, hlsjsPlayer, hlsEventsEnum, url = null, contentId = null) {
        ...
        this.peerAgentModule = new StreamrootPeerAgentModule(playerBridge, content, mediaMap, p2pConfig, SegmentView, streamType);
    }
}

export default HlsjsP2PWrapperLitePrivate;
