...
class HlsjsP2PWrapperPrivate {
     ...
     */
    createPlayer(hlsjsConfig, p2pConfig) {
        ...
        player.on(Hlsjs.Events.MANIFEST_LOADING, () => {
            ...
            this.startSession(player, hlsjsConfig, p2pConfig, player.url);
        });
        return player;
    }
    ...
    createSRModule(p2pConfig, hlsPlayer, hlsEventsEnum, contentId = null) {
        ...
        this.createPeerAgent(p2pConfig, hlsPlayer, hlsEventsEnum, null);
    }
     ...
     */
    startSession(hlsjsPlayer, hlsjsConfig, p2pConfig, contentUrl) {
        const Hlsjs = this.Hlsjs;
        ...
        this.createPeerAgent(p2pConfig, hlsjsPlayer, Hlsjs.Events, contentUrl);
     ...
     *
     */
    createPeerAgent(p2pConfig, hlsjsPlayer, hlsEventsEnum, url = null) {
