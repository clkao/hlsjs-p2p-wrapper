...
import SRModule from 'streamroot-p2p-dist';
...
class StreamrootWrapper {
  ...
  createSRModule (p2pConfig, hls, HlsEvents) {
    this.playerInterface = new PlayerInterface(hls, HlsEvents, p2pConfig, this.onDispose.bind(this), this.onAttach.bind(this), this.onDetach.bind(this));
    this.srModule = new SRModule(this.playerInterface, hls.url, undefined, hlsToSRMap, hlsToSRTrackCoordinate, hlsToSRSegmentCoordinate, p2pConfig);
  }
